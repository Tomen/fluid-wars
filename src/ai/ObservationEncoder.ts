...
export class ObservationEncoder {
  ...
  private cachedObstacles: any[] | null = null;
   ...
   */
  private getObstacleGrid(obstacles: any[]): number[][] {
   ...
   */
  private computeObstacleGrid(obstacles: any[]): number[][] {
   ...
   */
  private addObstacleCoverage(grid: number[][], obstacle: any): void {
    const { gridRows, gridCols } = this.config;
